...
function mediaChange(evt) {
  ...
  streamArea = document.getElementById('streams');
  media = 0;
               ...
               <div style="font-size: 0.85em; width: 100%;">
                  <div style="width: 100%;">
                     <div style="float: left; width: 50%; font-size: 1.25em; font-weight: bold;">
                        ...
                        <div>미디어 장치 선택</div>
                        <div>
                           <input type="radio" name="media" id="useNone" value="0" checked="checked" onchange="mediaChange(this)" />
                           <label for="useNone">사용하지 않음</label>
                           <input type="radio" name="media" id="useAudio" value="1" onchange="mediaChange(this)" />
                           <label for="useAudio">마이크 </label>
                           <input type="radio" name="media" id="useVideo" value="3" onchange="mediaChange(this)" />
                           <label for="useVideo">마이크와 카메라</label> <br />
                        </div>
                        <div id="streams" style="display: none;">
                           <b>미디어 전송 방식</b><br />
                           <input type="radio" name="stream" id="useOneway" value="0" onchange="mediaChange(this)" />
                           <label for="useOneway">단방향(1-&gt;N)</label>
                           <input type="radio" name="stream" id="useTwoway" value="1" onchange="mediaChange(this)" />
                           <label for="useTwoway">앙방향(1&lt;-&gt;1)</label>
                        </div>
                        <br />
